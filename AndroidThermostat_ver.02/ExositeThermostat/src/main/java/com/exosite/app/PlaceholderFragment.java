...
public class PlaceholderFragment extends Fragment {
    ...
    void prepareTabHost(View rootView) {
        ...
        ts.setIndicator(getResources().getString(R.string.outside_tab_label));
        tabHost.addTab(ts);
        ...
        ts.setIndicator(getResources().getString(R.string.basement_tab_label));
        ...
        ts.setIndicator(getResources().getString(R.string.living_tab_label));
    ...
    void updateWidgets() {
        ...
        Utils.setPressureTextView(mPreOut, mDevice.getPreOut(), mDevice.getPreOutDiff());
