...
public class Utils {
    ...
    public static final SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM  HH:mm");
    ...
    public static void setUpdateTextView(TextView textView, Date updateTime) {
        if (updateTime == null) {
            textView.setText("--");
        }
        else {
    ...
    public static void setTemperatureTextView(Activity activity, TextView textView, Double temperature, Double temperatureDiff) {
        if (temperature == null) {
            textView.setText("--");
            return;
        } else {
    ...
    public static void setPressureTextView(TextView textView, Double pressure, Double pressureDiff) {
        if (pressure == null) {
            textView.setText("--");
        } else {
    ...
    public static void setHumidityTextView(TextView textView, Double humidity, Double humidityDiff) {
        if (humidity == null) {
            textView.setText("--");
        } else {
    ...
    public static void setVoltageTextView(Activity activity, TextView textView, Integer voltage, Integer voltageDiff) {
        if (voltage == null) {
            textView.setText("--");
        }
        else {
    ...
    @SuppressLint ("SetTextI18n")
    public static void setUvIndexTextView(Activity activity, TextView textView, Integer uvIndex, Integer uvIndexDiff) {
        if (uvIndex == null) {
            textView.setText("--");
        }
        else {
    ...
    @SuppressLint ("SetTextI18n")
    public static void setLightTextView(TextView textView, Double light, Double lightDiff) {
        if (light == null) {
            textView.setText("--");
        }
        else {
