...
public class OnePlatformRPC {
    ...
    public String callRPC(String request) throws HttpRPCRequestException, HttpRPCResponseException {
        URL url;
        ...
        try {
            ...
            try {
                ...
                throw new HttpRPCResponseException("Failed to get http response.");
            }
            finally {
                if (null != reader) {
                    reader.close();
            ...
            throw new HttpRPCRequestException("Failed to open/close url connection.");
        }
        finally {
            if (conn != null) {
                conn.disconnect();
